...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
      final  Context context = holder.itemView.getContext();
        ...
        // implementaçao da funcionalidade de "abrir link"
        ...
        // implementaçao da funcionalidade de "compartilhar"
        ...
        if (news.favorite){
      holder.binding.ivFavorite.setColorFilter(context.getResources().getColor(R.color.purple_500));
